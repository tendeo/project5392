...
const Mainpage = ()=>{
   ...
   const handleDeleteNode = (e) =>{
        e.preventDefault();
        SetCurNodes((prevNodes) => prevNodes.filter(node => node.id !== DelNodeId));
        setDelNodeId("");
                        ...
                        <div className="message-node-form">
                            ...
                            <form onSubmit={handleSendMessage}>
                                ...
                                <div>
                                    ...
                                    <select id="node-dropdown-sender" 
                                            value = {SenderID}
                                ...
                                <div>
                                    ...
                                    <select id="node-dropdown-recevier" 
                                            value = {ReceiverID}
                                ...
                                {Accounts.length > 0 ? (
                                    Accounts.map((account) => (
                                        <div key={account.Email}>
                                            <p>
                                                {account.Email} : <button onClick={() => handleDeleteAccount(account.Email)}>Delete</button>
                                            </p>
                                        </div>
                                    ))
                                ) : (
